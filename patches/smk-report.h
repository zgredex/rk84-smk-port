...
/* Stock RK84 NKRO (report ID 6): 16 bytes = ID + 15 bitmap bytes,
 * 120 bits covering usages 0x04..0x70. NO modifier byte in this
 * report — modifiers live on the EP1 boot report (stock-identical). */
#define NKRO_FIRST_USAGE   0x04
#define NKRO_REPORT_BITS   15
#define NKRO_REPORT_SIZE   1 + NKRO_REPORT_BITS
